    ...
    mSearchBar(new QLineEdit(this))
{
    ...
    mSearchBar->setStyleSheet("color:white;");
    ...
    QString scrollbarStyle = "QScrollBar:vertical { background-color: transparent; width: 10px; }"
                            ...
                            "    min-height: 0px;"
                            "}";
    mListWidget->verticalScrollBar()->setStyleSheet(scrollbarStyle);
